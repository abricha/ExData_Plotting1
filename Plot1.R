## This script reads the Household power consumption data and plots a histogram
## of global active power in kilowats.It outputs the graph to a png file named plot1.png.
